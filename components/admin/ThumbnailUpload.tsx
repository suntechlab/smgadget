    ...
    <div className={cn("w-full space-y-4", className)}>
      ...
      >
        ...
        {hasImage ? (
          ...
          /* Empty State */
          <div className="flex aspect-[21/9] w-full flex-col items-center justify-center gap-4 p-8 text-center">
            <div className="rounded-full bg-primary/10 p-4">
              <ImageIcon className="size-8 text-primary" />
            </div>

            <div className="space-y-2">
              <h3 className="text-lg font-semibold">Upload Thumbnail</h3>
      ...
      {errors.length > 0 && (
        <Alert variant="destructive" appearance="light" className="mt-5">
          ...
          <AlertContent>
            <AlertTitle>Thumbnail upload error(s)</AlertTitle>
            <AlertDescription>
